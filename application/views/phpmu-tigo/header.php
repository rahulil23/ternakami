	...
	<div class='header-menu'>
		<div class='header-search'>
			".form_open('produk/index')."
				<input type='text' placeholder='Aku Mau Belanja..'' name='kata' class='search-input' style='border-radius: 20px;' required/>
		...
		<span class='city'>
          ...
          if ($this->session->id_konsumen != ''){
            ...
            echo "<a class='hidden-xs' href='".base_url()."members/orders_report'>Status Transaksi</a> &nbsp; &nbsp; 
            	  ...
            	  <a class='btn btn-xs btn-success' style='padding:1px 12px; border-radius:20px' href='".base_url()."members/profile'>Account</a> 
            	  <a class='btn btn-xs btn-danger' style='padding:1px 12px; border-radius:20px' href='".base_url()."members/logout'>Logout</a><br>";
			 ...
			 echo "<a class='hidden-xs' href='".base_url()."members/orders_report'>Status Transaksi</a> &nbsp; 
			 		<a href='".base_url()."produk/keranjang'> 
			 			<span class='glyphicon glyphicon glyphicon-shopping-cart' style='font-size:19px'></span></b> 
            	  	<span class='badge badgee'>".rupiah($isi_keranjang['jumlah'])."</span></a> &nbsp; ";
            echo "<a class='btn btn-xs btn-success' style='width:60px; border-radius:20px' href='".base_url()."auth/login'>Login</a> 
                  <a class='btn btn-xs btn-default' style='width:60px; color:#000; border-radius:20px' href='".base_url()."auth/register'>Daftar</a>";
